...
!function (e, t) {
    ...
    var O = function (e) {
        ...
        return f(t, d), a(t, [{
            ...
            key: "addResourceBundle", value: function (e, t, n, o, i) {
        ...
        return f(n, d), a(n, [{
            ...
            key: "translate", value: function (e, n) {
                ...
                var i = void 0 !== n.keySeparator ? n.keySeparator : this.options.keySeparator,
                    a = this.extractFromKey(e[e.length - 1], n), s = a.key, u = a.namespaces, l = u[u.length - 1],
                ...
                var g = this.resolve(e, n), h = g && g.res, d = g && g.usedKey || s, v = g && g.exactUsedKey || s,
                ...
                if (b && h && ("string" != typeof h && "boolean" != typeof h && "number" != typeof h) && ["[object Number]", "[object Function]", "[object RegExp]"].indexOf(y) < 0 && ("string" != typeof m || "[object Array]" !== y)) {
                ...
                } else if (b && "string" == typeof m && "[object Array]" === y) (h = h.join(m)) && (h = this.extendTranslation(h, e, n)); else {
                    var R = !1, j = !1;
                    ...
                    if (j || R || N) {
                        ...
                        if ("fallback" === this.options.saveMissingTo && E && E[0]) for (var P = 0; P < E.length; P++) C.push(E[P]); else "all" === this.options.saveMissingTo ? C = this.languageUtils.toResolveHierarchy(n.lng || this.language) : C.push(n.lng || this.language);
                        var F = function (e, t) {
            ...
            key: "extendTranslation", value: function (e, t, n, o) {
                var i = this;
                if (this.i18nFormat && this.i18nFormat.parse) e = this.i18nFormat.parse(e, n, o.usedLng, o.usedNS, o.usedKey, {resolved: o}); else if (!n.skipInterpolation) {
    ...
    var P = function () {
        ...
        return a(e, [{
            ...
            key: "interpolate", value: function (e, t, n, o) {
                var i, a, s, u = this,
                ...
                var f = function (e) {
                    ...
                    var t = e.split(u.formatSeparator), r = t.shift().trim(), o = t.join(u.formatSeparator).trim();
                ...
                for (s = 0; i = this.regexpUnescape.exec(e);) {
                    if (void 0 === (a = f(i[1].trim()))) if ("function" == typeof p) {
                        var g = p(e, i, o);
                        a = "string" == typeof g ? g : ""
                    } else this.logger.warn("missed to pass in variable ".concat(i[1], " for interpolating ").concat(e)), a = ""; else "string" == typeof a || this.useRawValueToEscape || (a = y(a));
    ...
    var T = function (e) {
        ...
        return f(t, d), a(t, [{
            ...
            key: "saveMissing", value: function (e, t, n, o, i) {
    ...
    return new (function (e) {
        ...
        return f(n, d), a(n, [{
            ...
            key: "loadResources", value: function () {
                var e = this, t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : U;
            ...
            key: "cloneInstance", value: function () {
                var e = this, t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                    ...
                    i = r({}, this.options, t, {isClone: !0}), a = new n(i);
