!(function (e, t) {
    "object" == typeof exports && "object" == typeof module ? (module.exports = t()) : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? (exports.zCarousel = t()) : (e.zCarousel = t());
})(window, function () {
    return ((n = {}),
    (e.m = t = [
        function (e, t, n) {
            "use strict";
            Object.defineProperty(t, "__esModule", { value: !0 }), n(1);
            var r = n(6);
        ...
        function (e, t, n) {
            ...
            n(4)(r, { hmr: !0, transform: void 0, insertInto: void 0 }), r.locals && (e.exports = r.locals);
        },
        function (e, t, n) {
            (e.exports = n(3)(!1)).push([
                e.i,
                '.z-carousel-wrapper .z-carousel>ul{margin:0;padding:0;list-style:none}.z-carousel-wrapper .z-carousel-pagination a{display:none;opacity:.3;width:14px;font-size:14px;font-weight:400;line-height:14px;margin:3px!important;color:inherit}.z-carousel-wrapper .z-carousel-pagination a.selected{opacity:.5}.z-carousel-wrapper .z-carousel-pagination a:before{content:"\\f111";font-family:FontAwesome}',
                "",
            ]);
        },
        function (e, t, n) {
        ...
        function (e, t, n) {
            ...
            function p(e, t) {
                for (var n = 0; n < e.length; n++) {
                    ...
                    if (i) {
                        ...
                        var s = [];
                        for (o = 0; o < r.parts.length; o++) s.push(b(r.parts[o], t));
            ...
            function b(e, t) {
                ...
                if (t.singleton) {
                    var a = c++;
                    (n = l || (l = y(t))), (r = C.bind(null, n, a, !1)), (i = C.bind(null, n, a, !0));
                } else
                    i =
                    ...
                    [
                        {
                            ...
                            value: function () {
                                ...
                                this.initItems(e, 0), 1 == this.jQueryCarousel.data("pagination") && this.addPagination(), e && 1 < e.length && this.registerCarouselTimer();
                            },
                        },
                        {
                            ...
                            value: function () {
                                setTimeout(
                                    function (e) {
                                        e.deregisterCarouselTimer(), (e.timer = setInterval(e.showNextItem, e.interval, e));
                                    },
                                    this.delay,
                                    this
                                );
                        ...
                        },
                        {
                            ...
                            value: function (e) {
                                ...
                                t >= e.items.length && (t = 0), e.showHideItems(e.items, t);
                            },
                        },
                        {
                            key: "initItems",
                            value: function (e, t) {
                                if (e) {
                                    ...
                                    (this.currentIndex = t),
                                        e.each(function (e) {
                                            return n.enterAnimation && n.registerAnimationEnd($(this)), e != t ? n.hideItem(e, $(this)) : n.showItem(e, $(this));
                                        });
                                }
                            },
                        },
                        {
                            key: "registerAnimationEnd",
                            value: function (e) {
                                if (e) {
                                    var t = this;
                                    e.on("animationend", function () {
                                        e.css("opacity", ""), e.removeClass("animated"), e.removeClass(t.enterAnimation);
                                    });
                                }
                            },
                        },
                        {
                            ...
                            value: function (e, t) {
                                if (e) {
                                    var n = e.get(this.currentIndex);
                                    this.hideItem(this.currentIndex, $(n)), (this.currentIndex = t);
                                    var r = e.get(this.currentIndex);
                                    this.showItem(this.currentIndex, $(r));
                                }
                            },
                        },
                        {
                            key: "loadItems",
                            value: function () {
                                return this.jQueryCarousel ? ((this.items = this.jQueryCarousel.find("li")), this.items) : null;
                            },
                        },
                        {
                            key: "loadDatas",
                            value: function () {
                                this.jQueryCarousel &&
                                    ((this.delay = this.jQueryCarousel.data("delay") || 2e3),
                                    (this.interval = this.jQueryCarousel.data("interval") || 3e3),
                        ...
                        },
                        {
                            ...
                            value: function () {
                                if (this.jQueryCarousel) {
                                    var e = this.jQueryCarousel.parent(".z-carousel-wrapper"),
                                        t = this.createPaginators();
                                    e.append($("<div class='z-carousel-pagination'></div>").append(t));
                                }
                            },
                        },
                        {
                            key: "createPaginators",
                            value: function () {
                                if (this.items) {
                                    var e = this;
                                    return (
                                        this.items.each(function (t) {
                                            var n = $("<a href='#'></a>");
                                            n.click(function (n) {
                                                n.preventDefault(), e.deregisterCarouselTimer(), e.showHideItems(e.items, t), e.registerCarouselTimer();
                                            }),
                                                e.paginators || (e.paginators = $()),
                                                (e.paginators = e.paginators.add(n));
                                        }),
                                        e.paginators
                                    );
                                }
