<div id="AddNewReview" class="modal modal-sm" xmlns="http://www.w3.org/1999/html">
    <form enctype="multipart/form-data" class="validate" method="post" id="ReviewAddForm"
          name="ReviewAddForm"  onsubmit="ReviewAddFormSubmit('ReviewAddForm'); return false;">
        <input type="hidden" id="UID" name="UID" value="0">
        <div class="modal-content">
            <h6 style="text-align: center;font-size: 1.45rem;" id="Head">ReviewCreate Modal</h6>
            <div class="row" style="margin-top: 30px;">
                ...
                <div class="col s12">
                    <div id="ReviewAddAjaxResult">  </div>
                </div>
            </div>
        </div>
        <div class="modal-footer">
            <button id="AddButton" class="btn btn-mini waves-effect waves-light gradient-45deg-green-teal"
                    type="button"
                    onclick="ReviewAddFormSubmit('ReviewAddForm');">Add
            </button>
