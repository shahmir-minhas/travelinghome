            ...
            <div class="container">
                <div class="row">
                    <div class="col s10 m12 l12 breadcrumbs-left">
                        <h5 class="breadcrumbs-title mt-0 mb-0 display-inline hide-on-small-and-down"><span>Buyers</span>
                        </h5>
...
<script>
    ...
    function DeleteUser(UID) {
        if (confirm("Are You Want To Remove User")) {
            ...
            if (response.status == 'success') {
                location.href = "<?=$path?>home/buyerList";
            }
        }
    }
    ...
    function EditUser(id) {
        ...
        if (rslt.Email != '') {
            ...
            $("#EditUser form#UserEditForm input#AccountType").val(rslt.AccountType);
