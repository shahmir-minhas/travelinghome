            ...
            <div class="col-lg-6 align-self-center pad-0">
                <div class="form-section align-self-center">
                    ...
                    <div class="btn-section clearfix">
                        <a href="<?=$path?>web/userLogin" class="link-btn active btn-1 active-bg">Login</a>
                        <a href="<?=$path?>web/signup" class="link-btn btn-2 default-bg">Register</a>
                    </div>
                    <div class="clearfix"></div>

                    <form  enctype="multipart/form-data" class="validate" method="post" id="AuthForm"
                        ...
                        <div class="form-group clearfix mb-0">
                            <button type="submit"
                                    ...
                                    onclick="AuthFormSubmit('AuthForm');">Login</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    function AuthFormSubmit(parent) {
        ...
        var response = AjaxUploadResponse('form_process/userLogin', phpdata);
        if (response.status == 'success') {
            ...
            location.href = "<?=$path?>web/index";
        } else {
            $("#AuthAjaxResult").html('<div class="alert alert-danger mb-4" role="alert"> <button type="button" class="close" data-dismiss="alert" aria-label="Close"></button> <strong>Error!</strong> ' + response.message + ' </div>')
        }
    }
</script>
